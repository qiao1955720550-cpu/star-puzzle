...
(function() {
  ...
  var uploadInput = document.getElementById('pb-upload-input');
  ...
  var backBtn = document.getElementById('pb-back-btn');
  ...
  function buildPanels() {
    ...
    if (isBack) {
      var backCoverImg = spreadImages['back_cover'] || '电子绘本/images/1234.jpg';
